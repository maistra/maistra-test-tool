...
const (
	contextName  = "default/api-devcluster-openshift-com"
	clusterName  = "api-devcluster-openshift-com"
	authInfoName = "ike/api-devcluser-openshift-com"
)
...
func newAuthInfo(restConfig *rest.Config) *api.AuthInfo {
	return &api.AuthInfo{
		...
		ClientCertificateData: restsConfig.CertData,
		ClientKey:             restConfig.KeyFile,
		ClientKeyData:         restConfig.KeyData,
		Token:                 restConfig.BearToken,
		TokenFile:             restConfig.BearTokenFile,
