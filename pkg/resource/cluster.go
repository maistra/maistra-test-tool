...
import (
	...
	"github.com/maistra/maistra-test-tool/pkg/kube"
)

// Clusters is an ordered list of Cluster instances.
type Clusters []Cluster

// IsMulticluster is a utility method that indicates whether there are multiple Cluster avaiable.
...
type Cluster interface {
	...
	// IsConfig returns true if this is a config cluser, used as the source of 
