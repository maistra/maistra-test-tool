...
func TestreviewV1(t TestHelper, file string) string {
	...
	templateString, err := os.ReadFile("../../../../testdata/resources/html/" + file)
	if err != nil {
	...
	os.WriteFile("../../../../testdata/resources/html/modified-"+file, []byte(htmlFile), 0644)
...
func TestreviewV2(t TestHelper, file string) string {
	...
	template2String, err := os.ReadFile("../../../../testdata/resources/html/" + file)
	if err != nil {
