...
log "Configure mesh1 smcp for using different root cert"
oc1 create -n mesh1-system secret generic cacerts \
...
oc1 -n mesh1-bookinfo apply -f ../bookinfo/bookinfo.yaml
oc1 -n mesh1-bookinfo apply -f ../bookinfo/bookinfo-ratings-v2.yaml
oc1 -n mesh1-bookinfo apply -f ../bookinfo/bookinfo-db.yaml
oc1 -n mesh1-bookinfo apply -f ../bookinfo/destination-rule-all.yaml

log "Installing bookinfo in mesh2"
oc2 -n mesh2-bookinfo apply -f ../bookinfo/bookinfo.yaml
oc2 -n mesh2-bookinfo apply -f ../bookinfo/bookinfo-ratings-v2.yaml
oc2 -n mesh2-bookinfo apply -f ../bookinfo/bookinfo-gateway.yaml
oc2 -n mesh2-bookinfo apply -f ../bookinfo/destination-rule-all.yaml
oc2 -n mesh2-bookinfo apply -f ../bookinfo/virtual-service-reviews-v3.yaml
